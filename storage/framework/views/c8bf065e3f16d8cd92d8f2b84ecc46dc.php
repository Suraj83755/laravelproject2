...
<!-- For favicon png -->
<link rel="shortcut icon" type="image/icon" href="<?php echo e(asset('assets/logo/favicon.png')); ?>"/>
...
<!-- bootsnav -->
<link rel="stylesheet" href="<?php echo e(asset('assets/css/bootsnav.css')); ?>">  
	...
	<body>
		...
		<section id="list-topics" class="list-topics">
			<div class="container">
				<div class="list-topics-content">
					<ul>
						<?php $__currentLoopData = $vare; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<li>
							<div class="single-list-topics-content  d-flex align-items-center p-3 bg-white rounded shadow-sm">
								<div class="single-list-topics-icon">
									<img src="<?php echo e(asset('storage/' . $j->image)); ?>" alt="explore image"  class="img-fluid rounded" style="width: 80px; height: 80px; object-fit: cover;">
								</div>
								<h2><a href="#"><?php echo e($j->type); ?></a></h2>
								<p><?php echo e($j->no_of_listing); ?></p>
							</div>
						</li>
			...
			<div class="container">
				...
				<!--<div class="works-content">
					<div class="row">
						...
						<div class="container">
						<div class="row ">
						<?php $__currentLoopData = $var; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class="col-md-4">
							<div class="single-how-works " style="height: 350px">
								<div class="single-how-works-icon">
									<img src="<?php echo e(asset('storage/' . $x->image)); ?>" alt="explore image" >
								</div>
								<h2><a href="#"><?php echo e($x->title); ?></a></h2>
								<p>
		...
		<section id="explore" class="explore">
			<div class="container">
				...
				<div class="explore-content" >
					<div class="row">
						<?php $__currentLoopData = $vard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class=" col-md-4">
							<div class="single-explore-item" style="height: 600px; width:350px">
								<div class="single-explore-img" >
									<!--<img src="assets/images/explore/e1.jpg" alt="explore image">-->
									<img src="<?php echo e(asset('storage/' . $k->image)); ?>" alt="explore image" height="75%">
									<div class="single-explore-img-info">
										<button onclick="window.location.href='#'"><?php echo e($k->type); ?></button>
								...
								<div class="single-explore-txt bg-theme-1">
									<h2><a href="#"><?php echo e($k->title); ?></a></h2>
									<p class="explore-rating-price">
										<span class="explore-rating"><?php echo e($k->rating); ?></span>
										<a href="#"><?php echo e($k->no_of_ratings); ?></a> 
										<span class="explore-price-box">
											form
											<span class="explore-price"><?php echo e($k->price); ?></span>
										</span>
										 <a href="#"><?php echo e($k->extra_text); ?></a>
									</p>
										...
										<div class="row">
											<div class="col-sm-2">
												<div class="explore-person-img">
													<a href="#">
														<img style="  max-width: 100%;height: auto; object-fit: cover; display: block;" src="<?php echo e(asset('storage/' . $k->image)); ?>" alt="blog image" style="height: 250px">
													</a>
												</div>
											</div>
											<div class="col-sm-10">
												<p>
													<?php echo e($k->content); ?>
									...
									<div class="explore-open-close-part">
										<div class="row">
											<div class="col-sm-5">
												<button class="close-btn" onclick="window.location.href='#'"><?php echo e($k->status); ?></button>
											</div>
											<div class="col-sm-7">
		...
		<section id="blog" class="blog" >
			<div class="container">
				...
				<div class="blog-content">
					<div class="row">
						<?php $__currentLoopData = $varc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $z): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class="col-md-4">
							<div class="single-blog-item" style="height: 400px">
								<div class="single-blog-item-img">
									<img src="<?php echo e(asset('storage/' . $z->img)); ?>" alt="blog image" style="height: 250px">
								</div>
								<div class="single-blog-item-txt">
									<h2><a href="#"><?php echo e($z->title); ?></a></h2>
									<h4>posted <span>by</span> <a href="#"><?php echo e($z->Role); ?></a> <?php echo e($z->Date); ?></h4>
									<p>
										<?php echo e($z->Content); ?>
		...
		<footer id="footer"  class="footer">
			<div class="container">
				...
				<?php $__currentLoopData = $varb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $z): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="row">
						...
						<div class="col-sm-7">
							<div class="footer-social">
								<span><i class="fa fa-phone"><?php echo e($z->Mobile_No); ?></i></span>
...
</html><?php /**PATH C:\xampp\htdocs\laravelproject\resources\views/index.blade.php ENDPATH**/ ?>