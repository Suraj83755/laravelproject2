    ...
    <div class="main-content">
      <div class="content-container">
          ...
          <div class="table-wrapper">
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td><?php echo e($y->Name); ?></td>
                  <td><?php echo e($y->Age); ?></td>
                  <td><?php echo e($y->email); ?></td>
                  <td><?php echo e($y->Gender); ?></td>
                  <td class="action-cell">
                    <a href="<?php echo e(Route('users.edit',['id'=>$y->id])); ?>" class="btn btn-action btn-edit" title="Edit">
        ...
        <div class="pagination-container">
          <?php echo e($var->links('pagination::bootstrap-5')); ?>
...
;color:#fefefe; ">Confirm Deletion</h1>
    ...
    margin-bottom: 1rem;"></i>
      ...
      <div class="clearfix row" style="display: flex;" >
        ...
        <a href="<?php echo e(url('/deletesign')); ?>/<?php echo e($y->id); ?>" class="btn btn-action btn-delete col-md-5" style="margin-left: 4%;" title="Delete">
...
<?php /**PATH C:\xampp\htdocs\laravelproject\resources\views/dashboard.blade.php ENDPATH**/ ?>