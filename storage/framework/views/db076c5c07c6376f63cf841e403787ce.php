    ...
    <div class="container py-5">
        ...
        <div class="form-container mb-5" style="margin-left: 20%;">
            <div class="card-header">
                <h2 class="mb-4 text-center" style="background: transparent; color:black;">Header Card <?php echo e(isset($editData) ? 'Edit' : 'Create'); ?></h2>
            </div>
            <div class="card-body">
                <form action="<?php echo e(isset($editData) ? route('card.update', $editData->id) : route('card.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="cardtitle" name="cardtitle" placeholder="Title Here"
                               value="<?php echo e(isset($editData) ? $editData->title : old('cardtitle')); ?>" 
                               required>
                    </div>
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea class="form-control" id="cardtext" placeholder="Text Here" name="cardtext" rows="1" 
                                  required><?php echo e(isset($editData) ? $editData->content : old('cardtext')); ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="cardimage" class="form-label">Image</label>
                        <?php if(isset($editData) && $editData->image): ?>
                            <img src="<?php echo e(asset('storage/' . $editData->image)); ?>" alt="Current Image" class="img-thumbnail" >
                        <?php endif; ?>
                        <input type="file" class="form-control" id="image" name="image" 
                               <?php echo e(!isset($editData) ? 'required' : ''); ?>>
                    </div>
                    </div>
                    ...
                    <?php if(isset($editData)): ?>
                        <a href="<?php echo e(route('card.index')); ?>" class="btn btn-secondary mt-2 w-100 bt-2">Cancel</a>
            ...
            <div class="table-container" >
              <div class="table-wrapper">
                <table>
                  ...
                  <tbody>
                    <?php $__currentLoopData = $var; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($item->id); ?></td>
                      <td><?php echo e($item->title); ?></td>
                      <td><?php echo e($item->content); ?></td>
                      <td>
                        <img src="<?php echo e(asset('storage/' . $item->image)); ?>" alt="Image" width="50px">
                        </td>
                        <td class="action-cell">
                            <a href="<?php echo e(Route('card.edit',['id'=>$item->id])); ?>" class="btn btn-action btn-edit" title="Edit">
      ...
      ;color:#fefefe; ">Confirm Deletion</h1>
          ...
          margin-bottom: 1rem;"></i>
            ...
            <div class="clearfix row" style="display: flex;" >
              ...
              <a href="<?php echo e(url('/deleteCARD/')); ?>/<?php echo e($item->id); ?>" class="btn btn-action btn-delete col-md-5" style="margin-left: 4%;" title="Delete">
