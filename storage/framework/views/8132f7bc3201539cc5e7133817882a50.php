        ...
        <div style="margin-left:16%; width:84%;">
            ...
            <div class="form-container">
                <div class="card-header">
                    <h2 class="mb-4 text-center">Explore Card <?php echo e(isset($editData) ? 'Edit' : 'Create'); ?></h2>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(isset($editData) ? route('explore.update', $editData->id) : route('explore.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <?php if(isset($editData) && $editData->image): ?>
                                        <img src="<?php echo e(asset('storage/' . $editData->image)); ?>" alt="Current Image" class="img-thumbnail mb-2" width="50px" height="50px">
                                    <?php endif; ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="type" name="type" required>
                                        ...
                                        <option value="best_rated" <?php echo e((isset($editData) && $editData->type == 'best_rated') ? 'selected' : ''); ?>>Best Rated</option>
                                        <option value="featured" <?php echo e((isset($editData) && $editData->type == 'featured') ? 'selected' : ''); ?>>Featured</option>
                                        <option value="most_view" <?php echo e((isset($editData) && $editData->type == 'most_view') ? 'selected' : ''); ?>>Most View</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="rating" name="rating" 
                                           value="<?php echo e(isset($editData) ? $editData->rating : old('rating')); ?>" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="no_of_ratings" name="no_of_ratings" 
                                           value="<?php echo e(isset($editData) ? $editData->no_of_ratings : old('no_of_ratings')); ?>" 
                                           required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="price" name="price" 
                                           value="<?php echo e(isset($editData) ? $editData->price : old('price')); ?>" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="extra_text" name="extra_text" 
                                           value="<?php echo e(isset($editData) ? $editData->extra_text : old('extra_text')); ?>" 
                                           maxlength="20" placeholder="Enter Content">
                                </div>

                                <div class="mb-3">
                                    <label for="secondary_image" class="form-label">Secondary Image</label>
                                    <?php if(isset($editData) && $editData->profilepic): ?>
                                        <img src="<?php echo e(asset('storage/' . $editData->profilepic)); ?>" alt="Current Image" class="img-thumbnail mb-2" width="50px" height="50px">
                                    <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="content" name="content" rows="1" placeholder="Content Here" maxlength="70"><?php echo e(isset($editData) ? $editData->content : old('content')); ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check" style="padding-right:20px;">
                                        <input class="form-check-input" type="radio" name="status" id="open" value="open" 
                                               <?php echo e((isset($editData) && $editData->status == 'open') ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="close" value="close" 
                                               <?php echo e((isset($editData) && $editData->status == 'close') ? 'checked' : ''); ?>>
                        ...
                        <div class="text-end mt-3">
                            ...
                            <?php if(isset($editData)): ?>
                                <a href="<?php echo e(route('explore.index')); ?>" class="btn btn-secondary  mt-2 w-100">Cancel</a>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="table-container" >
                        <div class="table-wrapper">
                            <table>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $exp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><img src="<?php echo e(asset('storage/' . $y->image)); ?>" alt="explore image" class="img-thumbnail"></td>
                                        <td><?php echo e($y->type); ?></td>
                                        <td><?php echo e($y->title); ?></td>
                                        <td><?php echo e($y->rating); ?></td>
                                        
                                        
                                        <td><?php echo e($y->extra_text); ?></td>
                                        <td><img src="<?php echo e(asset('storage/' . $y->profilepic)); ?>" alt="explore image" class="img-thumbnail"></td>
                                        <td><?php echo e(\Illuminate\Support\Str::limit($y->content, 20)); ?></td>
                                        <td>
                                        ...
                                        <td class="action-cell">
                                            ...
                                            <a href="<?php echo e(Route('explore.edit',['id'=>$y->id])); ?>" class="btn btn-action btn-edit" title="Edit">
      ...
      ;color:#fefefe; ">Confirm Deletion</h1>
          ...
          margin-bottom: 1rem;"></i>
            ...
            <div class="clearfix row" style="display: flex;" >
              ...
              <a href="<?php echo e(url('/deleteEXPLORE')); ?>/<?php echo e($y->id); ?>" class="btn btn-action btn-delete col-md-5" style="margin-left: 4%;" title="Delete">
...
</html><?php /**PATH C:\xampp\htdocs\laravelproject\resources\views/explore.blade.php ENDPATH**/ ?>